// Command model-explorer is a tiny web app for exploring the plan-vs-record data
// model in sqlite/schema.sql. It lets you build exercises and workout plans
// (the mutable "plan" tree), then start and execute a session (the immutable
// "record" tree) — surfacing how supersets, swap variants, and provenance work.
//
// This is a concept explorer, not production code: single user, single DB file.
package main

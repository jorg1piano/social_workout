...
INSERT INTO exercise (id, name) VALUES
  ...
  ('app-01BACKEXT000000000000000000', 'Back Extension'),
  ...
  ('app-01CHESTDIP00000000000000000', 'Chest Dip'),
  ('app-01CHESTDIPAS000000000000000', 'Chest Dip (Assisted)'),
  ('app-01CHESTFLY00000000000000000', 'Chest Fly'),
  ...
  ('app-01CHINUP0000000000000000000', 'Chin Up'),
  ...
  ('app-01HACKSQUAT0000000000000000', 'Hack Squat'),
  ...
  ('app-01LATPULLDSA0000000000000000', 'Lat Pulldown (Single Arm)'),
  ...
  ('app-01PULLUP0000000000000000000', 'Pull Up'),
  ...
  ('app-01PUSHUP0000000000000000000', 'Push Up'),
  ...
  ('app-01RUNNING000000000000000000', 'Running'),
  ...
  ('app-01SEATEDCLFRS00000000000000', 'Seated Calf Raise'),
  ...
  ('app-01SHOULDERPRSP00000000000000', 'Shoulder Press (Plate Loaded)'),
  ...
  ('app-01TRICEPDIP0000000000000000', 'Triceps Dip'),
  ('app-01TRICEPDIPASS00000000000000', 'Triceps Dip (Assisted)'),
  ('app-01TRICEPEXT0000000000000000', 'Triceps Extension'),
